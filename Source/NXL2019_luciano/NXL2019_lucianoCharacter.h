...
#include "NXL2019_lucianoCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class ANXL2019_lucianoCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class ANXL2019_lucianoProjectile> ProjectileClass;
