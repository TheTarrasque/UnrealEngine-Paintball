...
// Sets default values
AProceduralGeometry::AProceduralGeometry()
{
...
void AProceduralGeometry::PostActorCreated()
{
...
void AProceduralGeometry::PostLoad()
{
	Super::PostLoad();
	GenerateMesh();
...
void AProceduralGeometry::GenerateMesh()
{
	/*
...
void AProceduralGeometry::AddQuadMesh(FVector TopLeft, FVector BottomLeft, FVector TopRight, FVector BottomRight, int32& TriIndex)
{
...
void AProceduralGeometry::AddQuadMesh(FVector TopLeft, FVector BottomLeft, FVector TopRight, FVector BottomRight,int32& TriIndex, FProcMeshTangent Tangent)
{
	int32 Triangle1 = TriIndex++;
	int32 Triangle2 = TriIndex++;
	int32 Triangle3 = TriIndex++;
...
void AProceduralGeometry::AddTriangleMesh(FVector Point1, FVector Point2, FVector Point3, int32 & TriIndex, FProcMeshTangent Tangent)
{
	int32 Triangle1 = TriIndex++;
	int32 Triangle2 = TriIndex++;
	int32 Triangle3 = TriIndex++;
...
void AProceduralGeometry::AddTriangle(int32 p1, int32 p2, int32 p3)
{
...
void AProceduralGeometry::AddTriangle(int32 A, int32 B, int32 C, int32 D)
{
...
void AProceduralGeometry::PostEditChangeProperty(FPropertyChangedEvent & PropertyChangedEvent)
{
	...
	if ((MemberPropertyChanged == GET_MEMBER_NAME_CHECKED(AProceduralGeometry, CubeRadius)) || (MemberPropertyChanged == GET_MEMBER_NAME_CHECKED(AProceduralGeometry, InnerEdgeSize)))
	{
		GenerateMesh();
	}
	else if ((MemberPropertyChanged == GET_MEMBER_NAME_CHECKED(AProceduralGeometry, Material)))
	{
		ThisMesh->SetMaterial(0, Material);
	}
}
