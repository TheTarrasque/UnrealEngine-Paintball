...
UCLASS()
class NXL2019_LUCIANO_API APMCube : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	// This was my first experiment with dynamic properties. This will also be the testing ground for runtime changes
...
private:
	...
	//Deprecated the Triangle methods and combined them into the mesh methods
